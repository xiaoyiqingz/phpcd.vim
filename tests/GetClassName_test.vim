...
fun! TestCase_extract_class_from_the_same_file_when_line_referes_to_this()
    ...
    exe ':6'
    let classname = phpcd#GetClassName(6, '$this->', '\', {})
    call VUAssertEquals('FooClass', classname)

    let classname = phpcd#GetClassName(6, '$this->', 'Foo', {})
    call VUAssertEquals('Foo\FooClass', classname)

    exe ':7'
    let classname = phpcd#GetClassName(7, 'self::', '\', {})
    call VUAssertEquals('FooClass', classname)
    ...
    let classname = phpcd#GetClassName(10, '$this->', '\', {})
    call VUAssertEquals('FooClass', classname)

    exe ':11'
    let classname = phpcd#GetClassName(11, 'self::', '\', {})
    call VUAssertEquals('FooClass', classname)
...
fun! TestCase_finds_abstract_classes()
    ...
    exe ':12'
    let classname = phpcd#GetClassName(12, 'self::', '\', {})
    call VUAssertEquals('FooAbstract', classname)
...
fun! TestCase_finds_new_keyword_instantiations_in_parentheses_from_php5_4()
    ...
    let classname = phpcd#GetClassName(1, '$a = (new FooClass)->', '\', {})
    call VUAssertEquals('FooClass', classname)

    let classname = phpcd#GetClassName(1, '$a = (new \Foo\FooClass)->', 'Bar', {})
    call VUAssertEquals('Foo\FooClass', classname)

    let classname = phpcd#GetClassName(1, '$a = (new FooClass)->', 'Bar', {})
...
fun! TestCase_finds_variables_marked_with_AT_VAR_comments()
    ...
    exe ':3'
    let classname = phpcd#GetClassName(3, '$bar->', '\', {})
    call VUAssertEquals('FooClass', classname)

    exe ':6'
    let classname = phpcd#GetClassName(6, '$bar2->', '\', {})
    call VUAssertEquals('FooClass', classname)

    let classname = phpcd#GetClassName(6, '$bar2->', 'Bar', {})
    call VUAssertEquals('Bar\FooClass', classname)

    exe ':9'
    let classname = phpcd#GetClassName(9, '$bar3->', '\', {'Renamed': {'name': 'OriginalFoo', 'kind': 'c', 'builtin':0,}})
    call VUAssertEquals('OriginalFoo', classname)

    exe ':13'
    let classname = phpcd#GetClassName(13, '$foo_conflicting_sources->', '\', {})
    call VUAssertEquals('Foo', classname, 'when multiple sources available for the class name, explicit marker takes precedence')

    exe ':19'
    let classname = phpcd#GetClassName(19, '$foo2->', '\', {})
    call VUAssertEquals('Foo2', classname)

    exe ':25'
    let classname = phpcd#GetClassName(25, '$foo3->', '\', {})
    call VUAssertEquals('Foo3', classname)

    exe ':28'
    let classname = phpcd#GetClassName(28, '$foo2->', '\', {})
    call VUAssertEquals('Foo2', classname)

    exe ':32'
    let classname = phpcd#GetClassName(32, '$baz->', '\', {})
    call VUAssertEquals('FooClass2', classname)

    exe ':35'
    let classname = phpcd#GetClassName(35, '$baz2->', '\', {})
    call VUAssertEquals('FooClass2', classname)

    exe ':38'
    let classname = phpcd#GetClassName(38, '$baz3->', 'Bar', {})
...
fun! TestCase_finds_classes_from_variable_equals_new_class_lines()
    ...
    exe ':4'
    let classname = phpcd#GetClassName(4, '$foo->', '\', {})
    call VUAssertEquals('FooClass', classname)

    exe ':4'
    let classname = phpcd#GetClassName(4, '$foo->', 'Bar', {})
    call VUAssertEquals('Bar\FooClass', classname)

    exe ':8'
    let classname = phpcd#GetClassName(8, '$foo2->', '\', {'RenamedFoo': {'name': 'OriginalFoo', 'kind': 'c', 'builtin':0,}})
    call VUAssertEquals('OriginalFoo', classname)

    exe ':12'
    let classname = phpcd#GetClassName(12, '$foo3->', 'NS1', {})
...
fun! TestCase_returns_return_type_of_built_in_objects_static_methods()
    ...
    exe ':4'
    call phpcd#LoadData()
    let classname = phpcd#GetClassName(4, '$d->', '\', {})
    call VUAssertEquals('DateTime', classname)

    " built in class return values should not be affected by current namespace
    exe ':4'
    call phpcd#LoadData()
    let classname = phpcd#GetClassName(4, '$d->', 'Bar', {})
    call VUAssertEquals('DateTime', classname)

    exe ':7'
    call phpcd#LoadData()
    let classname = phpcd#GetClassName(7, '$d->', '\', {'DT': {'name': 'DateTime', 'kind': 'c', 'builtin':1,}})
    call VUAssertEquals('DateTime', classname)
...
fun! TestCase_returns_class_from_static_method_call()
    ...
    let classname = phpcd#GetClassName(1, 'FooClass::', '\', {})
    call VUAssertEquals('FooClass', classname)

    let classname = phpcd#GetClassName(1, 'FooClass::', 'Bar', {})
    call VUAssertEquals('Bar\FooClass', classname)

    let classname = phpcd#GetClassName(1, 'RenamedFoo::', '\', {'RenamedFoo': {'name': 'OriginalFoo', 'kind': 'c', 'builtin':0,}})
    call VUAssertEquals('OriginalFoo', classname)
endf
...
fun! TestCase_returns_class_from_tags_with_tag_of_v_kind_and_a_new_equals_class_cmd()
    ...
    exe ':3'
    let classname = phpcd#GetClassName(3, '$foo_only_in_tags->', '\', {})
    call VUAssertEquals('FooClass', classname)

    " TODO
    " exe ':5'
    " let classname = phpcd#GetClassName('$foo_only_in_tags::')
    " call VUAssertEquals('FooClass', classname)
    silent! bw! %
endf
...
fun! TestCase_extract_typehint_from_function_calls()
    ...
    exe ':4'
    let classname = phpcd#GetClassName(4, '$bar->', '\', {})
    call VUAssertEquals('FooClass1', classname)

    " typehinds are affected by current namespace as everyting else
    let classname = phpcd#GetClassName(4, '$bar->', 'Bar', {})
    call VUAssertEquals('Bar\FooClass1', classname)

    exe ':8'
    let classname = phpcd#GetClassName(8, '$bar->', '\', {})
    call VUAssertEquals('FooClass2', classname)

    exe ':12'
    let classname = phpcd#GetClassName(12, '$bar->', '\', {})
    call VUAssertEquals('FooClass3', classname)

    exe ':16'
    let classname = phpcd#GetClassName(16, '$bar->', '\', {})
    call VUAssertEquals('FooClass4', classname)

    exe ':20'
    let classname = phpcd#GetClassName(20, '$bar->', '\', {})
    call VUAssertEquals('FooClass5', classname)

    exe ':24'
    let classname = phpcd#GetClassName(24, '$bar->', '\', {})
    call VUAssertEquals('FooClass6', classname)

    exe ':28'
    let classname = phpcd#GetClassName(28, '$bar->', '\', {})
    call VUAssertEquals('FooClass7', classname)

    exe ':33'
    let classname = phpcd#GetClassName(33, '$bar->', '\', {})
    call VUAssertEquals('FooClass8', classname)

    exe ':40'
    let classname = phpcd#GetClassName(40, '$bar->', '\', {})
    call VUAssertEquals('FooClass9', classname, 'expect $baz to use type-hinting from class method')

    exe ':45'
    let classname = phpcd#GetClassName(45, '$baz->', '\', {})
    call VUAssertEquals('FooClass10', classname, 'expect $baz to use type-hinting from class method')

    exe ':50'
    let classname = phpcd#GetClassName(50, '$bar->', '\', {'RenamedFoo': {'name': 'OriginalFoo', 'kind': 'c', 'builtin':0,}})
    call VUAssertEquals('OriginalFoo', classname)

    exe ':58'
    let classname = phpcd#GetClassName(58, '$multi->', '\', {})
    call VUAssertEquals('DateTime', classname)
...
fun! TestCase_extract_parameter_type_from_docblock()
    ...
    exe ':11'
    let classname = phpcd#GetClassName(11, '$bar1->', '\', {})
    call VUAssertEquals('BarClass1', classname)

    exe ':11'
    let classname = phpcd#GetClassName(11, '$bar1->', 'Bar', {})
    call VUAssertEquals('Bar\BarClass1', classname)

    exe ':27'
    let classname = phpcd#GetClassName(27, '$bar2->', '\', {})
    call VUAssertEquals('BarClass2', classname)

    exe ':39'
    let classname = phpcd#GetClassName(39, '$bar3->', '\', {})
    call VUAssertEquals('BarClass3', classname)

    exe ':54'
    let classname = phpcd#GetClassName(54, '$docblocked->', '\', {})
    call VUAssertEquals('DateTime', classname)
...
fun! TestCase_returns_static_function_calls_return_type()
    ...
    exe ':15'
    let classname = phpcd#GetClassName(15, '$u->', '\', {})
...
fun! TestCase_returns_static_function_calls_retun_type_with_namespaces()
    ...
    exe ':32'
    let classname = phpcd#GetClassName(32, '$p->', 'Foo', imports)
    call VUAssertEquals('Foo\Page', classname)

    exe ':35'
    let classname = phpcd#GetClassName(35, '$p->', 'Foo', imports)
    call VUAssertEquals('Foo\Page', classname)

    exe ':38'
    let classname = phpcd#GetClassName(38, '$p->', 'Foo', imports)
    call VUAssertEquals('Foo\Page', classname)

    exe ':41'
    let classname = phpcd#GetClassName(41, '$p->', 'Foo', imports)
    call VUAssertEquals('Foo\Page', classname)

    exe ':44'
    let classname = phpcd#GetClassName(44, '$p->', 'Foo', imports)
    call VUAssertEquals('Foo\Page', classname)

    exe ':47'
    let classname = phpcd#GetClassName(47, '$p->', 'Foo', imports)
    call VUAssertEquals('Foo\Page', classname)

    exe ':50'
    let classname = phpcd#GetClassName(50, '$p->', 'Foo', imports)
    call VUAssertEquals('Foo\Page', classname)
...
fun! TestCase_resolves_call_chains_return_type_with_this()
    ...
    exe ':89'
    let classname = phpcd#GetClassName(89, '$this->', 'FooNS', {})
    call VUAssertEquals('FooNS\Foo', classname)

    exe ':85'
    let classname = phpcd#GetClassName(85, '$this->getSomething()->', 'FooNS', {})
    call VUAssertEquals('FooNS\SomethingNS\Something', classname)

    exe ':53'
    let classname = phpcd#GetClassName(53, '$this->getSomething()->', 'FooNS\SubNameSpace', {})
    call VUAssertEquals('FooNS\SomethingNS\Something', classname)
...
fun! TestCase_resolves_call_chains_return_type_with_tags()
    ...
    exe ':13'
    let classname = phpcd#GetClassName(13, '$this->', 'NS1\SubNS2', {})
    call VUAssertEquals('NS1\SubNS2\Level1', classname)

    exe ':14'
    let classname = phpcd#GetClassName(14, '$this->getLevel31Instance()->', 'NS1\SubNS2', {})
    call VUAssertEquals('NS31\SubNS\Level31', classname)

    exe ':15'
    let classname = phpcd#GetClassName(15, '$this->getAnother31Instance()->', 'NS1\SubNS2', {})
    call VUAssertEquals('NS31\SubNS\Level31', classname)
...
fun! TestCase_resolves_call_chains_return_type_with_php5_4_new()
    ...
    exe ':18'
    let classname = phpcd#GetClassName(18, '(new Foo)->return_bar()->', '\', {})
...
fun! TestCase_resolves_call_chains_return_type_with_when_chain_head_class_detectable()
    ...
    exe ':68'
    let classname = phpcd#GetClassName(68, '$foo->return_bar()->return_foo()->return_bar()->', '\', {})
    call VUAssertEquals('Bar', classname)

    exe ':71'
    let classname = phpcd#GetClassName(71, '$foo->return_bar()->return_foo()->return_bar()->', '\', {})
    call VUAssertEquals('Bar', classname)

    exe ':74'
    let classname = phpcd#GetClassName(74, '$foo->return_bar()->return_foo()->return_bar()->', '\', {})
    call VUAssertEquals('Bar', classname)

    exe ':77'
    let classname = phpcd#GetClassName(77, '$foo->bar->', '\', {})
    call VUAssertEquals('Bar', classname)

    exe ':78'
    let classname = phpcd#GetClassName(78, '$foo->bar->', '\', {})
    call VUAssertEquals('Bar', classname)

    exe ':79'
    let classname = phpcd#GetClassName(79, '$foo->bar->', '\', {})
    call VUAssertEquals('Bar', classname)

    exe ':80'
    let classname = phpcd#GetClassName(80, '$foo->bar->foo->', '\', {})
...
fun! TestCase_resolves_call_chains_return_type_with_when_chain_head_class_detectable_with_builtin_types()
    ...
    exe ':87'
    let classname = phpcd#GetClassName(87, '$doc->createAttribute()->ownerElement->', '\', {})
    call VUAssertEquals('DOMElement', classname)

    exe ':90'
    let classname = phpcd#GetClassName(90, '$d->add()->getTimezone()->', '\', {})
    call VUAssertEquals('DateTimeZone', classname)

    exe ':94'
    let classname = phpcd#GetClassName(94, '$tz->', '\', {})
    call VUAssertEquals('DateTimeZone', classname)

    exe ':98'
    let classname = phpcd#GetClassName(98, '$foobar->', '\', {})
    call VUAssertEquals('Foo', classname)
    ...
    exe ':105'
    let classname = phpcd#GetClassName(105, '$bar2->', '\', {})
    call VUAssertEquals('Bar', classname)

    exe ':109'
    let classname = phpcd#GetClassName(109, '$bar3->return_foo()->', '\', {})
    call VUAssertEquals('Foo', classname)
...
fun! TestCase_handles_array_completion()
    ...
    exe ':12'
    let classname = phpcd#GetClassName(12, '$a[42]->', '\', {})
    call VUAssertEquals('Foo', classname)

    exe ':24'
    let classname2 = phpcd#GetClassName(24, '$foo[0]->', '\', {})
    call VUAssertEquals('Foo', classname2)

    exe ':28'
    let classname3 = phpcd#GetClassName(28, '$foo2->fooarray[42]->', '\', {})
    call VUAssertEquals('Foo', classname3)

    exe ':33'
    let classname4 = phpcd#GetClassName(33, '$foo4[42]->', '\', {})
    call VUAssertEquals('Foo', classname4)

    exe ':38'
    let classname5 = phpcd#GetClassName(38, '$f->', '\', {})
    call VUAssertEquals('Foo', classname5)

    exe ':43'
    let classname6 = phpcd#GetClassName(43, '$f->', '\', {})
    call VUAssertEquals('Foo', classname6)

    exe ':48'
    let classname7 = phpcd#GetClassName(48, '$f->', '\', {})
    call VUAssertEquals('Foo', classname7)

    exe ':53'
    let classname7 = phpcd#GetClassName(53, '$f->', '\', {})
    call VUAssertEquals('Foo', classname7)
...
fun! TestCase_handles_parent_keyword()
    ...
    exe ':6'
    let classname = phpcd#GetClassName(6, 'parent::', '\', {})
...
fun! TestCase_catch_clause()
    ...
    exe ':5'
    let classname = phpcd#GetClassName(5, '$e->', '\', {})
    call VUAssertEquals('Exception', classname)

    exe ':11'
    let classname = phpcd#GetClassName(11, '$e->', '\', {})
...
fun! TestCase_builtin_function_return_type()
    ...
    exe ':5'
    let classname = phpcd#GetClassName(5, '$xml->', 'Foo', {})
...
fun! TestCase_function_return_type()
    ...
    exe ':29'
    let classname = phpcd#GetClassName(29, '$foo->', 'Foo', {})
    call VUAssertEquals('Foo\FooClass', classname)

    exe ':32'
    let classname = phpcd#GetClassName(32, '$foo2->', 'Foo', {'F': {'cmd': '/^class FooClass {$/', 'static': 0, 'name': 'FooClass', 'namespace': 'Foo', 'kind': 'c', 'builtin': 0, 'filename': 'fixtures/GetClassName/function_return_type.php'}})
    call VUAssertEquals('Foo\FooClass', classname)
    ...
    exe ':32'
    let classname = phpcd#GetClassName(32, '$foo2->', 'Foo', {'F': {'cmd': '/^class FooClass {$/', 'static': 0, 'name': 'FooClass', 'kind': 'c', 'builtin': 0, 'filename': 'fixtures/GetClassName/function_return_type.php'}})
    call VUAssertEquals('Foo\FooClass', classname)
...
fun! TestCase_function_invocation_return_type()
    ...
    exe ':35'
    let classname = phpcd#GetClassName(35, 'simplexml_load_string()->', 'Foo', {})
    call VUAssertEquals('SimpleXMLElement', classname)

    exe ':38'
    let classname = phpcd#GetClassName(38, 'make_a_foo()->', 'Foo', {})
    call VUAssertEquals('Foo\FooClass', classname)

    " renamed imports need tags to locate the renamed class
    exe 'set tags='.tags_path
    exe ':41'
    let classname = phpcd#GetClassName(41, 'make_a_renamed_foo()->', 'Foo', {})
    call VUAssertEquals('Foo\FooClass', classname)
...
fun! TestCase_resolves_self_this_static_in_return_docblock()
    ...
    exe ':32'
    let classname = phpcd#GetClassName(32, '$b2->return_self()->', '', {})
    call VUAssertEquals('Baz2', classname)

    exe ':33'
    let classname = phpcd#GetClassName(33, '$b2->return_this()->', '', {})
    call VUAssertEquals('Baz2', classname)

    exe ':34'
    let classname = phpcd#GetClassName(34, '$b2->return_static()->', '', {})
    call VUAssertEquals('Baz2', classname)
...
fun! TestCase_resolves_self_this_static_in_return_docblock_in_array_situation()
    ...
    exe ':38'
    let classname = phpcd#GetClassName(38, '$self->', '', {})
    call VUAssertEquals('Baz3', classname)

    exe ':42'
    let classname = phpcd#GetClassName(42, '$that->', '', {})
    call VUAssertEquals('Baz3', classname)

    exe ':46'
    let classname = phpcd#GetClassName(46, '$static->', '', {})
    call VUAssertEquals('Baz3', classname)
...
fun! TestCase_resolves_classnames_with_multiple_methods_recursively()
    ...
    exe ':16'
    let classname = phpcd#GetClassName(16, '$result->', '', {})
...
fun! TestCase_resolves_classnames_with_multiple_methods_recursively_even_with_extra_whitespace()
    ...
    exe ':18'
    let classname = phpcd#GetClassName(18, '$result->', '', {})
    call VUAssertEquals('Model', classname)
...
fun! TestCase_resolves_classnames_from_cloned_variables()
    ...
    exe ':5'
    let classname = phpcd#GetClassName(5, '$d->', '', {})
    call VUAssertEquals('DateTime', classname)
...
fun! TestCase_should_not_loop_forever_around_stuff_having_the_word_class_class_in_them()
    ...
    exe ':8'
    let classname = phpcd#GetClassName(8, '$this->', '', {})
    ...
    exe ':16'
    let classname = phpcd#GetClassName(15, 'parent::', '', {})
    call VUAssertEquals('DateTime', classname)
...
fun! TestCase_resolves_inside_a_function_body()
    ...
    exe ':11'
    let classname = phpcd#GetClassName(11, '$d->', '', {})
    ...
    exe ':20'
    let classname = phpcd#GetClassName(20, '$d->', '', {})
    call VUAssertEquals('DateTime', classname) " the result in itself is wrong, the plugin picks up the class word inside of a string

    exe ':25'
    let classname = phpcd#GetClassName(25, '$d->', '', {})
    call VUAssertEquals('DateTime', classname) " the result in itself is wrong, the plugin picks up the class word inside of a string
